...
public class MoveToSystem extends IteratingSystem {
   ...
   // private ShapeRenderer sr;
    ...
    protected void processEntity(Entity entity, float deltaTime) {
        ...
        Vector2 start = new Vector2((posComp.position.x + offComp.offsetX) / 32 , (posComp.position.y + offComp.offsetY) / 32);
        ...
        // flying enemies doesn't have obstacles so there's no reason for it to use findPath method
