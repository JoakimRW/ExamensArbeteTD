...
/**
 * This is a helper class that loads the map and then creates a list of tiles of
 * that map. Created by MichaelSjogren on 2017-02-23.
 */
public abstract class LevelManager {
	 ...
	 * 
	 * @param filePath
	 *            The path of where the file is , root is in your assets folder
	 **/
	...
	/**
	 * You need to divide by the x / tile width and y / tile height if you have
	 * pixel cords This will only work with Tile coordinates
	 * 
	 * @param x
	 *            The x position of the Tile
	 * @param y
	 *            The y position of the Tile
	 * @return if the coordinates are not out of bounds : returns Tile object ,
