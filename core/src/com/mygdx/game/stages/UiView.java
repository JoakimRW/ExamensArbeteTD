...
public class UiView implements Screen {
    ...
    public void render(float delta) {
        getStage().act(delta);
        if (PlayState.START_GAME) _nextWaveTimeValue.setText(String.valueOf(WaveTimeManager.CURRENT_WAVE_TIME));
        getStage().draw();
    }
    ...
    /** getters **/
    public Label get_nextWaveTimeValue() {return _nextWaveTimeValue;}

    public Label getToolTip_tower_lbl() {return toolTip_tower_lbl;}
